...
const dummyData = [
    ...
    },
    {
        ...
        desc: "The Problem: Challenges of Traditional Tax Reporting Infrastructure. The current tax reporting infrastructure suffers from several limitations due to its reliance on point-to-point integrations between various entities. These limitations include: Error-prone data exchange: Data transfer between banks, financial institutions, government agencies, and taxpayers is cumbersome and error-prone due to the use of multiple intermediaries. This increases the risk of data corruption or loss and makes it difficult to trace the origin and maintain the integrity of data throughout the reporting process. Additionally, the system struggles to handle high transaction volumes efficiently, especially during peak seasons.",

        link: "/sciences_ai/blogDetails5",
        date: "07-08-2024",
    },
];
const Blogs = () => {
