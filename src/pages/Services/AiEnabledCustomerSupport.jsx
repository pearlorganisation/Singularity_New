...
import TicketHandling from "../../assets/singularity/TicketHandling.png";
import StreamlinedSupport from "../../assets/singularity/StreamlinedSupport.png";

import EfficientCustomer from "../../assets/singularity/EfficientCustomer.png";
import CustomerInteraction from "../../assets/singularity/CustomerInteraction.png";

const AiEnabledCustomerSupport = () => {
  const homeStyle = {
      ...
      <div className="container mx-auto grid place-items-center px-6">
        <div className="md:pt-24 md:py-24 grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-0">
          <div className="flex flex-col justify-center gap-1  font-medium md:font-normal items-center md:items-start text-center md:text-left text-xl lg:text-3xl xl:text-4xl order-2 md:order-1">
            ...
            <div className="flex flex-col text-xl text-left">
              <ul className="text-base font-normal md:font-medium md:text-lg list-disc ml-5 text-center md:text-left">
                {[
                  `Automate managing support tickets using Ai`,
                  `Ensure consistent and efficient customer support operations.`,
                ].map((item) => (
                  <li>{item}</li>
                ))}
              </ul>
          ...
          <div className="w-full">
            <ServiceSlider images={[TicketHandling]} />
          </div>
        </div>
        ...
        <div className="md:pt-24 md:py-24 grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-0">
          <div className="flex flex-col justify-center gap-1  font-medium md:font-normal items-center md:items-start text-center md:text-left text-xl lg:text-3xl xl:text-4xl order-1 md:order-[0]">
            ...
            <div className="flex flex-col text-xl text-left">
              <ul className="text-base font-normal md:font-medium md:text-lg list-disc ml-5 text-center md:text-left">
                {[
                  `Embrace a clutter-free support experience with Singularity's automated interface, `,
                  `Enable natural and intuitive support processes.
                  `,
                ].map((item) => (
                  <li>{item}</li>
                ))}
          ...
          <div className="w-full">
            <ServiceSlider images={[StreamlinedSupport]} />
          </div>
        </div>
        ...
        <div className="md:pt-24 md:py-24 grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-0">
            ...
            <div className="flex flex-col text-xl text-left">
              <ul className="text-base font-normal md:font-medium md:text-lg list-disc ml-5 text-center md:text-left">
                {[
                  ...
                  `Manage customer information at scale and strengthen support operations.
                  `,
                ].map((item) => (
                  <li>{item}</li>
                ))}
          ...
          <div className="w-full">
            <ServiceSlider images={[EfficientCustomer]} />
          </div>
        </div>
        ...
        <div className="md:pt-24 md:py-24 grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-0 pb-5 md:pb-0">
          <div className="flex flex-col justify-center gap-1  font-medium md:font-normal items-center md:items-start text-xl text-center md:text-left lg:text-3xl xl:text-4xl order-1 md:order-[0]">
            ...
            <div className="flex flex-col text-xl text-left">
              <ul className="text-base font-normal md:font-medium md:text-lg list-disc ml-5 text-center md:text-left">
                {[
                  `Optimize your support processes with Singularity's automated interaction handling`,
                  `Promptly address customer inquiries`,
                  `Provide customized responses to boost customer satisfaction and loyalty
                  `,
                ].map((item) => (
                  <li>{item}</li>
                ))}
          ...
          <div className="w-full">
            <ServiceSlider images={[CustomerInteraction]} />
          </div>
        </div>
      </div>
    </div>
...
export default AiEnabledCustomerSupport;
